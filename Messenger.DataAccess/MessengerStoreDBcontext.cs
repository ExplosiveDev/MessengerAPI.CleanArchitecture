...
{
	public class MessengerStoreDBcontext(
		DbContextOptions<MessengerStoreDBcontext> options,
		IOptions<AuthorizationOption> authOptions) : DbContext(options)
	{
		...
		{
			modelBuilder.ApplyConfigurationsFromAssembly(typeof(MessengerStoreDBcontext).Assembly);
		}
	}
}
