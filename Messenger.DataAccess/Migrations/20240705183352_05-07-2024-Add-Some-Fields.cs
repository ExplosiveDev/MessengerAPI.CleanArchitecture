...
{
    /// <inheritdoc />
    public partial class _05072024AddSomeFields : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ChatEntityMessageEntity", x => new { x.ChatsId, x.MessagesId });
                    table.ForeignKey(
                        name: "FK_ChatEntityMessageEntity_Chats_ChatsId",
                        column: x => x.ChatsId,
                        principalTable: "Chats",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ChatEntityMessageEntity_Messages_MessagesId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChatEntityMessageEntity_MessagesId",
                table: "ChatEntityMessageEntity",
                column: "MessagesId");
